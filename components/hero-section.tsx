      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">Awnikant Ajay</span>, a Full-Stack & GenAI Developer from{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">Kalyani</span>
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            I build intelligent web systems using AI, scalable backends, and modern web technologies.
          </p>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-7 pt-4">
            ...
            <a
              href="https://drive.google.com/file/d/1FWNMdUBUeWw62JfmhV1KdiSA2lIhIIPv/view?usp=sharing"
              target="_blank"
