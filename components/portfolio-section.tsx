...
export function PortfolioSection() {
  const projects = [
    {
      title: "Web3 Credential Platform",
      description:
        "A decentralized credential platform built during an MLH hackathon that issues verifiable NFT-based certificates using ERC-721 smart contracts on Polygon. Includes role-based access control and a serverless minting system.",
      tag: "Blockchain / Web3",
    ...
    {
      title: "CNN Pneumonia Detection Model",
      description:
        "Developed a deep learning model that classifies pneumonia from chest X-ray images using convolutional neural networks. Built during a Deep Learning Summer School program exploring modern AI architectures.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ...
            <span className="bg-[#FFC224] text-black px-3 py-1 inline-block">featured projects</span>
          </h2>
        </div>
